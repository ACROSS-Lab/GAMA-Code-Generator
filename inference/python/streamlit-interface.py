...
def create_chain(system_prompt):
    ...
    (repo_id, model_file_name) = ("Phanh2532/GAMA-Code-Generator-v0.1-GGUF",
                                "ggml-model-f16.gguf")

    model_path = "/home/phuong-anh/gama/llama.cpp/models/gama-model/ggml-model-f16.gguf"
    ...
    llm = LlamaCpp(
            ...
            temperature=0, max_tokens=512, top_p=1,
            # callback_manager=callback_manager, n_gpu_layers=1, n_batch=512, n_ctx=4096,
            stop=["[INST]"],
            verbose=False,
            streaming=True,
            )
